...
set_property PACKAGE_PIN V3 [get_ports {pw}]
set_property IOSTANDARD LVCMOS33 [get_ports {pw}]
set_property PACKAGE_PIN W3 [get_ports {statusLED}]
...
set_property PACKAGE_PIN W19 [get_ports {pswrdOK}]
set_property IOSTANDARD LVCMOS33 [get_ports {pswrdOK}]
##Bank = 14, Pin name = ,							Sch name = BTNR
#set_property PACKAGE_PIN T17 [get_ports {resetBTN}]
...
set_property PACKAGE_PIN A14 [get_ports {controlPin}]
set_property IOSTANDARD LVCMOS33 [get_ports {controlPin}]
...
set_property PACKAGE_PIN K17 [get_ports {neoPin}]
set_property IOSTANDARD LVCMOS33 [get_ports {neoPin}]
##Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {pcPin}]
set_property IOSTANDARD LVCMOS33 [get_ports {pcPin}]
